  ...
  return (
    <div className="np">
      ...
      <style>{`
        ...
        .np__hero-img{ display: block; width: auto; max-width: 100%; height: auto; max-height: 260px; margin: 0 auto; object-fit: contain; object-position: center; }
